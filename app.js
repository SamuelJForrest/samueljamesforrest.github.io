...
const projects = [
  ...
  },
  {
    name: 'To-Do list',
    description:
      'A to-do list that allows you to filter items based on their completion status. This app also saves to-dos to local storage to revisit them later.',
    languages: ['HTML', 'SCSS', 'JS'],
